...
public class SnakeMissileEffect extends AbstractGameEffect {
    ...
    private SnakeMissileAction parentAction;
    private Color effectColor;

    public SnakeMissileEffect(float originX, float originY, float targetX, float targetY, Color effectColor) {
    ...
    public void update() {
        ...
        if (this.duration > 0.5f) {
            ...
            AbstractDungeon.effectsQueue.add(new SnakeMissileTrailEffect(this.x + this.img.packedWidth / 2.0f, this.y + this.img.packedHeight / 2.0f, effectColor.cpy()));
